...
const CreatePost = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      const response = await apiRequest.post("/post/createpost", payload, {
        headers: {
    ...
    <div className="min-h-screen w-[90%] lg:w-[70%] mx-auto my-12 p-8 text-black rounded-xl shadow-xl">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-8">
        ...
        <div className="flex gap-2 items-center border border-black p-4 border-dashed rounded-lg bg-opacity-10">
          <Label className="font-semibold text-lg">Upload Cover Image</Label>
        ...
        <div className="my-2 flex flex-col gap-2">
          ...
          <div className="grid w-full gap-2">
            ...
            <p className="text-[12px] opacity-60">
              Hi! I'm your AI writing assistant. Give me a prompt like `write a
              paragraph on meditation` or `suggest blog titles on
        ...
        >
          {loading ? <p>Publishing...</p> : <p> Publish Blog</p>}
        </Button>
      </form>
    </div>
  );
